cordova.define("cordova-plugin-schedule.Schedule", function(require, exports, module) {
/*
    Copyright 2015-2018 Vrisini Infotech
...
Schedule.prototype = {
     ...
     */
    cancel: function (id) {
        cordova.exec(null, null, 'Schedule', 'cancel', [id.toString()]);
    },
     ...
     */
    cancelAll: function () {
        cordova.exec(null, null, 'Schedule', 'cancelAll', []);
    },
    ...
    getScheduledIds: function (callback) {
        cordova.exec(callback, null, 'Schedule', 'getScheduledIds', []);
    },
    ...
    isScheduled: function (id, callback) {
        cordova.exec(callback, null, 'Schedule', 'isScheduled', [id.toString()]);
    },
    ...
    hasPermission: function (callback, scope) {
        ...
        cordova.exec(fn, null, 'Schedule', 'hasPermission', []);
    },
    ...
    promptForPermission: function () {
        cordova.exec(null, null, 'Schedule', 'promptForPermission', []);
    },
...
var plugin  = new Schedule(),
    channel = require('cordova/channel');

channel.deviceready.subscribe( function () {
    cordova.exec(null, null, 'Schedule', 'deviceready', []);
});
    ...
    channel.onCordovaInfoReady.subscribe( function () {
        if (device.platform == 'Android') {
            channel.onPause.subscribe( function () {
                cordova.exec(null, null, 'Schedule', 'pause', []);
            });

            channel.onResume.subscribe( function () {
                cordova.exec(null, null, 'Schedule', 'resume', []);
            });
